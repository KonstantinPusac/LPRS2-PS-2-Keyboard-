...
void init_scan_code_to_ascii() {
  ...
  scan_code_to_ascii[0x15] = 'q'; scan_code_to_ascii[0x2D] = 'r';
  ...
  scan_code_to_ascii_shifted[0x5D] = '|'; scan_code_to_ascii_shifted[0x29] = ' ';
  scan_code_to_ascii_shifted[0x5A] = '\n';*/
}
...
void _decode(unsigned char sc) {
  ...
  extended = false; // Reset extended state after processing the scancode
}
